...
Error: File to import not found or unreadable: vars.
       Load path: H:/web/github/hotel/node_modules/node-sass/test/fixtures/include-path
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: vars.\A        Load path: H:/web/github/hotel/node_modules/node-sass/test/fixtures/include-path\A         on line 1 of H:\web\github\hotel\node_modules\node-sass\test\fixtures\include-path\index.scss\A \A 1: @import 'vars';\A 2: @import 'colorBlue';\A 3: \A 4: body {\A 5:   background: $color;\A 6:   color: colorBlue();"; }
